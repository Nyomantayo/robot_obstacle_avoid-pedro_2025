...
// const int SERVO_KANAN = SERVO_STOP - 25;
// const int SERVO_KIRI  = SERVO_STOP + 25;
...
// // PWM config
// const int PWM_FREQ = 5000; // 20 kHz
...
//   spdKiri = 90;
//   spdKanan = 116;
//   motorKiri(SPEED_MAJU);
//   motorKanan(SPEED_MAJU);
// }
...
//   motorKanan(-SPEED_TURN); // spin kanan
// }
...
//   spdKanan = 126;
//   Serial.println("Kiri");
//   motorKiri(-SPEED_TURN);  // spin kiri
